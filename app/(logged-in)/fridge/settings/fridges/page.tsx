...
export default function FridgesPage() {
  ...
  const copy =
    locale === "fr"
      ? {
          title: "Mes frigos",
          subtitle: "Gerez vos differents espaces de stockage",
          ...
          deleteDesc:
            "Toutes les boites d'oeufs de ce frigo seront supprimees. Cette action est irreversible.",
          deleteAction: "Supprimer",
          toastCreated: "Frigo cree !",
          toastUpdated: "Frigo mis a jour !",
          toastDeleted: "Frigo supprime !",
          toastDefaultSet: "Frigo par defaut defini !",
