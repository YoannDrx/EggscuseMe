      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Des idées pour cuisiner vos oeufs selon leur fraîcheur
          </p>
        </div>
      </div>
        ...
        <CardContent className="flex items-center gap-4 py-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Ajoutez des boîtes d&apos;oeufs pour recevoir des suggestions
              personnalisées !
            </p>
          </div>
        </CardContent>
        ...
        <Card variant="sunny" className="border-fresh-cook bg-fresh-cook/5">
          <CardContent className="flex items-start gap-3 py-4">
            ...
            <p className="text-sm">
              ...
              bientôt à expiration. Voici des recettes pour les utiliser avant
