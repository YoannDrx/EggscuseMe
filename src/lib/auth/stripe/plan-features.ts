...
export const PRICING_COPY = {
  fr: {
    ...
    // Plan Chef
    chefTitle: "Chef",
    chefDescription: "Pour les pros et gros volumes",
    chefPrice: "14,99€",
    chefPriceSuffix: "/mois",
    chefYearlyEquivalent: "8,33€",
    chefYearlyTotal: "99,99€",
    chefYearlySuffix: "/an",
    chefInheritance: "Tout ce qui est inclus dans Brigade, plus :",
    ...
    headerSubtitleChef: "Vous êtes un Chef !",
  ...
  en: {
    ...
    // Plan Chef
    chefTitle: "Chef",
    chefDescription: "For pros and high volume",
    chefPrice: "€14.99",
    chefPriceSuffix: "/month",
    chefYearlyEquivalent: "€8.33",
    chefYearlyTotal: "€99.99",
    chefYearlySuffix: "/year",
    chefInheritance: "Everything in Brigade, plus:",
    chooseChef: "Go Chef",
    chefBadge: "Pro",
    ...
    headerSubtitleChef: "You are a Chef!",
